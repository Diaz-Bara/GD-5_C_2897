...
const LoginPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    router.push('/home'); // Mengarahkan ke halaman game setelah login sukses
  };
    ...
    <AuthFormWrapper title="Login">
      <form onSubmit={handleSubmit} className="space-y-5 w-full">
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <Link href="/auth/forgot-password" size-sm className="text-blue-600 hover:text-blue-800 text-sm font-semibold">
            Forgot Password?
          </Link>
        </div>
